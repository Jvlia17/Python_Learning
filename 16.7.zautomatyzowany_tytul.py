# 16.7 Zautomatyzowany tytuł. W tym podrozdziale tytuł był określany ręcznie podczas definiowania egzemplarza my_layout. To oznacza konieczność przeprowadzania aktualizacji tytułu po każdej zmianie pliku źródłowego.
